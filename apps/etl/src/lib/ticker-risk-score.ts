/**
 * Deterministic FinAI ticker risk score (5–95) for equities.
...
} from "./sec-edgar/extract-from-sec-metrics";
...
/**
 * Computes FinAI risk score. Higher = more risk / demand for attention in
